module.exports = [
    ...
    "What do you think of tattoos? Do you have any? Would you ever get one?",
    ...
    "What's your favorite movie quote? Which movie was it from?",
    ...
    "What's your favorite Discord Server and why?",
    "How many Discord Bots are in your server? (If you own/manage one.)",
    "What's your favorite Discord Bot and why? (I won't judge you for not picking me :v)",
    "What's your highest level in a Discord Server? (IE: HepBoat, MEE6, Arcane etc etc.)",
    "How long have you been on Discord?",
    "What's the stupidest thing you've witnessed someone do or say on Discord?",
    "What made you join Discord?",
    "What was the first Discord Server you ever joined, and why?",
    "Do you like to listen to music with friends by using Bots on Discord like Zira Music, Groovy, Rythm? Or do you prefer to use Spotify or another method?",
    "Are there any Discord Bots you dislike? Why do you dislike them?",
    "Are you part of Discord's HypeSquad? Which House did you join and why?",
    "What's the longest call you've ever made on Discord? (Public voice channels also count!)",
